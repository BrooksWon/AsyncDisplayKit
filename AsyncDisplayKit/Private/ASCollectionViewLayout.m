...
- (void)scheduleLayout
{
  ...
  NSDictionary<NSArray<NSArray<ASIndexedNodeContext *> *> *, ASCellNode *> *nodeContexts = nil;
  ...
  dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
    ...
    [ASCollectionViewLayout
     ...
     completion:^(ASLayout *layout) {
       ASCollectionLayout *collectionLayout = [[ASCollectionLayout alloc] initWithLayout:layout nodeContexts:nodeContexts];
